                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="text-2xl font-bold credflow-gradient bg-gradient-to-r from-blue-600 to-purple-600">
                                CredFlow
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {/* Profile Dropdown (hidden on auth pages) */}
                    ...
                    <div className="px-4 py-4 space-y-2">
                        ...
                        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <button
                                ...
                                className="flex items-center w-full px-4 py-3 text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-colors duration-200"
                            >
